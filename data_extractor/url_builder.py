...
def build_url():
    """This function builds an URL for each event that is maintained in the "events.json" file.
    ...
    with open(r"config_files\events.json", "r") as events_file:
        events = json.load(events_file)

    # get the necessary values from events.json
